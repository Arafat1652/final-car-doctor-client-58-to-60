  ...
  return (
    <div className="carousel w-full h-[600px]">
      <div id="slide1" className="carousel-item relative w-full">
        ...
        />
        <div className="absolute rounded-lg flex items-center h-full left-0 top-0 bg-gradient-to-r from-[#151515] to-[rgba(21, 21, 21, 0) 100%)] ">
          <div className='space-y-7 text-white w-1/2  pl-12 '>
            ...
            <div>
                <button className='btn bg-[#FF3811] text-white border-0 mr-5'>Discover More</button>
